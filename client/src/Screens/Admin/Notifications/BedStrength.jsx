...
const API_URL = "http://localhost:5000/api/bed-strengths";
  ...
  return (
    <div className="min-h-[80vh] py-4 font-sans">
      <MenuTable 
        ...
        data={data}
        columns={columns}
        addPath="/admin/notifications/bed-strength/add"
        tableState={tableState}
      />

      {/* The SortMenuController is not needed for server-side sorting */}
